...
sont au centre du réseau ou s'ils sont adjacents à un marcheur fixe."""
...
grilleFixe[centreReseau, centreReseau] = True
# On fixe un site collant à x, y = (128, 128), au centre du reseau
...
plt.savefig('Laboratoire9-figureQ6-1.png')
...
plt.savefig('Laboratoire9-figureQ6-2.png')
